        ...
        <div className="container-custom mx-auto px-4">
          ...
          >
            ...
            <p className={isDark ? "text-neutral-400" : "text-gray-600"}>
              Choose the perfect plan to grow your social presence
            </p>
          </motion.div>
            ...
            {service?.plans?.map((plan, index) => (
              <motion.div
                ...
                className={`rounded-3xl p-8 relative transition-all ${
                  plan.highlighted
                    ? `bg-linear-to-br from-pink-600 to-rose-700 text-white transform lg:scale-105 shadow-2xl`
                    : isDark
            ...
            {[
              {
                ...
                a: "We manage Facebook, Instagram, TikTok, LinkedIn, Twitter, and YouTube. Platform selection depends on your target audience and business goals.",
              },
              {
                q: "How often do you post?",
                a: "Post frequency varies by plan. Growth plans start at 12 posts/month, Accelerate at 24 posts/month, and Influencer tier at 40+ posts/month across all platforms.",
              },
              {
                q: "Can you create our brand voice?",
                a: "Absolutely! We'll work with you to develop an authentic brand voice that resonates with your audience and aligns with your business values.",
              },
              {
                q: "What if we're not satisfied with results?",
                a: "We focus on strategy and engagement metrics. We provide weekly/monthly reports so you can see exactly what's working and discuss adjustments anytime.",
              },
            ].map((faq, index) => (
              <motion.div
                key={faq.q}
      ...
      <section className={`py-16 lg:py-24 ${isDark ? "bg-dark-950" : "bg-gray-50"}`}>
        <div className="container-custom mx-auto px-4 text-center">
          ...
          <p className={`text-xl mb-8 max-w-2xl mx-auto ${isDark ? "text-neutral-400" : "text-gray-600"}`}>
            Let's create a social media strategy that drives engagement and builds your brand community.
          </p>
          <Link
            href="/contact"
