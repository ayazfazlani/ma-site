        ...
        <div className="container-custom mx-auto px-4">
          ...
          >
            <h1 className={`text-5xl lg:text-6xl font-bold mb-6 ${isDark ? "text-white" : "text-gray-900"}`}>
              PPC <span className="gradient-text">Advertising</span>
            </h1>
        ...
        <div className="container-custom mx-auto px-4">
          ...
          >
            ...
            <p className={isDark ? "text-neutral-400" : "text-gray-600"}>
              Choose the perfect PPC strategy for your growth goals
            </p>
          </motion.div>
            ...
            {service?.plans?.map((plan, index) => (
              <motion.div
                ...
                className={`rounded-3xl p-8 relative transition-all ${
                  plan.highlighted
                    ? `bg-linear-to-br from-green-600 to-emerald-700 text-white transform lg:scale-105 shadow-2xl`
                    : isDark
      ...
      <section className={`py-16 lg:py-24 ${isDark ? "bg-dark-900" : "bg-white"}`}>
        <div className="container-custom mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            {[
              {
                q: "How much is the management fee vs. ad spend?",
                a: "Our management fees are separate from ad spend. You control your daily budget, and we optimize to get the best ROI possible.",
              },
              {
                q: "What's a good PPC budget to start with?",
                a: "Most effective campaigns run $3,000-10,000/month in ad spend. Smaller budgets are possible but may limit reach. We'll recommend based on your industry and goals.",
              },
              {
                q: "How quickly will I see results from PPC?",
                a: "PPC delivers immediate visibility. You can see clicks within hours of launch. However, optimization takes 2-4 weeks to show peak performance.",
              },
              {
                q: "What if my budget isn't being spent?",
                a: "If your budget isn't fully utilized, it indicates strong ad quality scores or limited audience size. We'll adjust targeting or bid strategies to maximize spend efficiency.",
              },
            ].map((faq, index) => (
              <motion.div
                key={faq.q}
      ...
      <section className={`py-16 lg:py-24 ${isDark ? "bg-dark-950" : "bg-gray-50"}`}>
        <div className="container-custom mx-auto px-4 text-center">
          <h2 className={`text-4xl font-bold mb-6 ${isDark ? "text-white" : "text-gray-900"}`}>
            Get Immediate Traffic and Leads with PPC
          </h2>
          <p className={`text-xl mb-8 max-w-2xl mx-auto ${isDark ? "text-neutral-400" : "text-gray-600"}`}>
            Let's create a profitable PPC strategy that drives qualified leads and revenue for your business.
          </p>
          <Link
            href="/contact"
          ...
          >
            Get PPC Strategy <ArrowRight className="w-5 h-5" />
          </Link>
        </div>
      </section>
    </main>
