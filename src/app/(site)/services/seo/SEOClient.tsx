            ...
            {service?.plans?.map((plan, index) => (
              <motion.div
                ...
                className={`rounded-3xl p-8 relative transition-all ${
                  plan.highlighted
                    ? `bg-linear-to-br from-primary-600 to-primary-700 text-white transform lg:scale-105 shadow-2xl`
                    : isDark
            ...
            {[
              {
                ...
                a: "SEO is a long-term strategy. Most clients see noticeable improvements in 3-6 months, with significant results within 6-12 months depending on competition and current website state.",
              },
              {
                q: "What makes your SEO different?",
                a: "We combine technical expertise with data-driven strategies. We focus on sustainable, white-hat SEO practices that deliver long-term results without risking penalties.",
              },
              {
                q: "Do you guarantee first position rankings?",
                a: "No legitimate SEO company guarantees rankings. We guarantee our effort, expertise, and transparent reporting. Success depends on many factors including competition, content quality, and market conditions.",
              },
              {
                q: "What's included in the monthly retainer?",
                a: "Our retainers include ongoing optimization, monitoring, reporting, and strategy adjustments. Specific services vary by plan tier.",
              },
            ].map((faq, index) => (
              <motion.div
                key={faq.q}
      ...
      <section className={`py-16 lg:py-24 ${isDark ? "bg-dark-950" : "bg-gray-50"}`}>
        <div className="container-custom mx-auto px-4 text-center">
          ...
          <p className={`text-xl mb-8 max-w-2xl mx-auto ${isDark ? "text-neutral-400" : "text-gray-600"}`}>
            Let's discuss your SEO goals and create a strategy that drives real results for your business.
          </p>
          <Link
            href="/contact"
